...
function switcher() {
    echo ' <div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-12 desc">Im sorry but Im not sure how to help you with that......</p>
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 fs-12 desc">Im sorry but im not sure how...</p>
...
function offcanvas_sidebar() {
    echo '<div class="offcanvas offcanvas-end" tabindex="-1" id="header-sidebar" aria-labelledby="sidebarLabel">
            ...
            <div class="tab-pane border-start-0 border-end-0 rounded-0 p-0" id="notifications" role="tabpanel">
                <div class="list-group list-group-flush ">
                    <div class="list-group-item d-flex  align-items-center">
                        ...
                        <div class="ms-3">
                            <strong>Madeleine</strong> Hey! there Iam available....
...
function banner() {
    ...
    echo '<section id="common_banner_area">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="commn_banner_page">
                        <h2><span class="color_big_heading">' . $title . '</span></h2>
                        <ul class="breadcrumb_wrapper">
                            <li class="breadcrumb_item"><a href="index">Home</a></li>
                            <li class="breadcrumb_item"><img src="assets/img/icon/arrow.png" alt="img"></li>
                            <li class="breadcrumb_item active">' . $title . '</li>
                        </ul>
                    </div>
                </div>
            </div>
