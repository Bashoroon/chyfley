                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="" method="post" style="display: inline;" onsubmit="return    confirm('Are you sure you want to delete this gallery?');">
                                                            ...
                                                            <button type="submit" class="btn btn-danger" name="delete-event-btn">Delete</button>
                                                        </form>

                                                        <!-- Add links for Edit and Update as needed -->
                                                        <a href="edit-event.php?id=<?php echo $event['event_id']; ?>">Edit</a>
