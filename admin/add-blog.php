...
$recentBlogs = $chyfleyObj->recent_news();
if (isset($_POST['add-blog-cat-btn'])) {
    $chyfleyObj->add_news_cat();
}
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="prism-toggle">
                                        <button class="btn btn-sm btn-primary-light">Add Blog<i class="ri-code-line ms-2 d-inline-block align-middle"></i></button>
                                    </div>
                                </div>
                                <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php foreach ($blogCats as $blogCat) { ?>
                                            <div class="card-bodsy mbs-3">
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="category" value="<?php print $blogCat['category_name']; ?>" id="primaryChecked" checked="">
                                    ...
                                    <div class="card-bosdy mb-3">
                                        <button type="submit" name="add-blog-btn" class="btn btn-primary">Add Blog</button>
                                    </div>
                                </form>
                            </div>
                            <div class="card-footer d-none border-top-0">
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="prism-toggle">
                                        <button class="btn btn-sm btn-primary-light">Add Blog Category<i class="ri-code-line ms-2 d-inline-block align-middle"></i></button>
                                    </div>
                                </div>
                                <form action="" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="card-bosdy mb-3">
                                            <button type="submit" name="add-blog-cat-btn" class="btn btn-primary">Add Ctegory</button>
                                        </div>
                                </form>
                            </div>
                            <div class="card-footer d-none border-top-0">
