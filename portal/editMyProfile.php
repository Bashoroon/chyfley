    ...
    <div class="wrapper">
        <div class="container" style="margin-top: 3%;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <?php  } else { ?>
                                <img src="<?php print $nameFound['passport']; ?>" alt="user" class="rounded-circle" style="height: 100px; width: 100px; object-fit: cover;">
                            <?php } ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="updateDP.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input id="demo1" value="<?php print $nameFound['id']; ?> " type="hidden" value="" class="form-control" name="id">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select id="demo1" type="" value="<?php print $teacher['cert']; ?>" class="form-control" name="cert">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label class="control-label">Assigned Subject</label>
                        <input id="demo1" type="text" readonly value="<?php print $teacher['subject']; ?>" class="form-control" name="subject">
