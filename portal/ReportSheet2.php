                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6" id="non-printable">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Tss Portal</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Excel</a></li>
                                                ...
                                                <table id="" class="minimalistBlack">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($rowz = mysqli_fetch_array($sqlSelectScore)) {;
                                                            ...
                                                            $sqlStudentScore =  $conn->query("SELECT * from studentscores where session = '$session' and term='First' and class = '$class' and admissionNo='$admissionNo' and subject='" . $rowz['subject'] . "'");
                                                            $result = mysqli_fetch_array($sqlStudentScore);
                                                            $sqlStudentScoreSecond =  $conn->query("SELECT * from studentscores where session = '$session' and term='Second' and class = '" . $result['class'] . "' and admissionNo='$admissionNo' and subject='" . $rowz['subject'] . "' ");
                                                            $studentScoreSecond = mysqli_fetch_array($sqlStudentScoreSecond);

                                                            $sqlStudentScoreThird =  $conn->query("SELECT * from studentscores where session = '$session' and term='Third' and class = '$class' and admissionNo= '$admissionNo' and subject='" . $rowz['subject'] . "'");
                                                            $studentScoreThird = mysqli_fetch_array($sqlStudentScoreThird);

                                                            $firstTermScore = $result['test'] + $result['test_two'] + $result['exam'];
                                                            $secondTermScore = $studentScoreSecond['test'] + $studentScoreSecond['test'] + $studentScoreSecond['exam'];
