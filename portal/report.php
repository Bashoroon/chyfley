...
?>
    <head>
        <meta charset="utf-8" />
        <title>Tender's Report Sheet</title>
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active"><?php echo $cla['class']; ?></li>
                                </ol>
                            </div>
                            <h4 class="page-title">Report Sheet</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
...
?>
                                        ...
                                        <table id="tech-companies-1" class="table table-striped" style="bo">
                                            <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th data-priority="1">Subject</th>
                                                <th data-priority="3">Ca</th>
...
?>                  
                                            ...
                                            <tr>
                                                <th><span class="co-name"><?php  echo $row['name']; ?></span></td>
