                        ...
                        <div class="card-body">
                            ...
                            <table id="score-ssheet" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    $studentScore = $recordController->edit($id);

                                    $studentName = $studentController->student_name($studentScore['admissionNo']);
                                    ...
                                    <tr>
                                        <form  method="POST">
                                            ...
                                            <td><input type="number" class="form-control" max="20" name="test" value="<?php print $studentScore['test']; ?>"></td>
                                            <td><input type="number" class="form-control" max="20" name="testTwo" value="<?php print $studentScore['test_two']; ?>"></td>
                                            <td><input type="number" class="form-control" name="exam" value="<?php print $studentScore['exam']; ?>" max="60" ></td>


                                            <td><button type="submit" name="update-score" class="btn btn-secondary">Submit</button>
                                        </form>
                                    </tr>
                                    <?php  ?>
                                </tbody>
