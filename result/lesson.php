                                    ...
                                    <div class="card mb-0">
                                        ...
                                        <div class="card-header" id="headingOne<?php print $sub['id']; ?>">
                                            <h5 class="mb-0 mt-0 font-14">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php print $sub['id']; ?>" aria-expanded="false" aria-controls="collapseOne<?php print $sub['id']; ?>" class="text-dark">
                                        ...
                                        <?php while ($topic = mysqli_fetch_array($sqlTopic)) { ?>
                                            <div id="collapseOne<?php print $sub['id']; ?>" class="collapse " aria-labelledby="headingOne<?php print $sub['id']; ?>" data-parent="#accordion">
                                                <div class="card-body">
                                                    <a href="lesson.php?noteid=<?php print $topic['noteid']; ?>&term=<?php print $term; ?>& class=<?php print $class; ?>"> <?php print $topic['topic']; ?></a>
