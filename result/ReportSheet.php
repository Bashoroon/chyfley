...
<!--Chartist Chart CSS -->
<link rel="stylesheet" href="../portal/plugins/chartist/css/chartist.min.css">
                      ...
                      <div class="card-body">
                        <table id="report" class="minimalistBlack">
                          <thead>
                            ...
                            $sqlTotalTest = $conn->query("SELECT  sum(test+test_two) as totalTest from studentscores where session = '$session' and term = '$term' and admissionNo='$user' ");
                        ...
                        <table id="" class="minimalistBlack">
                          ...
                          <tbody>
                            ...
                            while ($result = mysqli_fetch_array($sqlSelect)) {;
                              ...
                              $grade = $result['test'] + $result['test_two'] + $result['exam'];
                            ...
                            ?>
                              ...
                              $sqlTotalTest = $conn->query("SELECT  sum(test+test_two) as totaltest from studentscores  where session = '$session' and term = '$term' and class='$class'  and admissionNo='$user' ");
                              $sqlTotalExam = $conn->query("SELECT  sum(exam) as totalexam from studentscores  where session = '$session' and term = '$term' and class='$class'  and admissionNo='$user' ");
                              $totalTest = mysqli_fetch_assoc($sqlTotalTest);
                              $totalExam = mysqli_fetch_assoc($sqlTotalExam);
                        ...
                        <div class="row">
                          ...
                          <?php if ($term !== "Third") { ?>
                            <div class="col-8"> <b>Principal's Comment:</b> <i style=""><?php if ($percentage >= 70) {
                                                                                          ...
                                                                                          print $poor;
                                                                                        } ?></i></div><?php } else { ?> <div class="col-8"> <b>Principal's Comment:</b> <i style=""><?php if ($percentage >= 70) {
                                                                                                                                                                                                                                                                                                                                                                                                                    print $excellent . " " . "Promoted to next class";
                                                                                                                                                                                                                                                                                                                                                                                                                  } elseif ($percentage >= 60) {
                                                                                                                                                                                                                                                                                                                                                                                                                    print $very_good . " " . "Promoted to next class $jss2";
                                                                                                                                                                                                                                                                                                                                                                                                                  } elseif ($percentage >= 50) {
                                                                                                                                                                                                                                                                                                                                                                                                                    print $average . " " . "Promoted to next class";
                                                                                                                                                                                                                                                                                                                                                                                                                  } elseif ($percentage >= 40) {
                                                                                                                                                                                                                                                                                                                                                                                                                    print $fair . " " . "Promoted to next class";
                                                                                                                                                                                                                                                                                                                                                                                                                  } elseif ($percentage >= 30) {
                                                                                                                                                                                                                                                                                                                                                                                                                    print $poor;
                                                                                                                                                                                                                                                                                                                                                                                                                  } ?></i></div> <?php } ?>
                          ...
                          <!--  <div class="col-8" style="font-size:1vw;"> <strong>Principal's Comment:</strong>  <i style="font-size:1vw;"> <?php if ($percentage >= 70) {
                                                                                                                                                echo "<b>An excellent performance. Keep it up.<b>";
                                                                                                                                              } elseif ($percentage >= 60) {
                                                                                                                                                echo "A very good performance. Do not relent.";
                                                                                                                                              } elseif ($percentage >= 50) {
                                                                                                                                                echo "An average performance. Work harder next term.  ";
                                                                                                                                              } elseif ($percentage >= 40) {
                                                                                                                                                echo "A fair performance. Improve in your weak area.";
                                                                                                                                              } elseif ($percentage >= 30) {
                                                                                                                                                echo "A poor performance";
                                                                                                                                              } elseif ($percentage <= 30) {
                                                                                                                                                echo "A very poor performance";
                                                                                                                                              } ?> </i></div>
