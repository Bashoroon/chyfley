                ...
                <div class="pagination text-center">
                    <nav aria-label="...">
                        <ul class="pagination justify-content-center flex-wrap">
                            ...
                            ?>
                                <li class="page-item step <?php echo $activeClass; ?>" id="pgn" >
...
<center><br><br><?php include 'footer.php'; ?></center>
        ...
        $("input[name^='studentAns']").change(function() {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $(".page-item.step").each(function() {
                    $(this).addClass("disabled");  // Adds a disabled style
                ...
                success: function(response) {
                    ...
                    $("#nextBtn").prop('disabled', false);
                    $(".page-item.step").each(function() {
                    $(this).removeClass("disabled");  // Removes the disabled style
                    $(this).find("a").off("click");   // Re-enables the click event
});
